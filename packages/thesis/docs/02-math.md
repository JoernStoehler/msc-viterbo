...
**Support / gauge / polar.** For a convex body \(K\subset\mathbb R^4\) with \(0\in\mathrm{int}\,K\):
...
!!! definition "Admissible polytope"
    <a id="def-admissible-polytope"></a>
...
!!! definition "Lagrangian vs. non‑Lagrangian 2‑face"
    <a id="def-lagrangian-face"></a>
...
These are the Hamiltonian velocities of the quadratic Hamiltonian \(H=g_K^2\) on \(\partial K\); see the next section.
...
!!! proposition "Facet behaviour"
    <a id="prop-facet-behaviour"></a>
...
!!! definition "Polygonal Hamiltonian orbit"
    <a id="def-polygonal-orbit"></a>
...
!!! definition "Simple Hamiltonian orbit"
    <a id="def-simple-orbit"></a>
...
For a convex body \(K\), the Ekeland–Hofer–Zehnder capacity is
...
!!! theorem "HK combinatorial formula (4D)"
    <a id="thm-hk-combinatorial"></a>
