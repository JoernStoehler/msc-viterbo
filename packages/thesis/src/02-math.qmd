...
**Definition (Polygonal Hamiltonian orbit).** A Hamiltonian closed characteristic on a polytope is **polygonal** if it has a representative \(\gamma\) with a finite partition \(0=t_0<\dots<t_m=T\) such that
