---
title: Haim–Kislev & Ostrover (2024) — Counterexample to Viterbo via Lagrangian Pentagons
slug: haim-kislev-ostrover-2024-counterexample
summary: Exhibits $K\times T$ (regular pentagon × 90° rotation) with $\mathrm{sys}(K\times T)>1$, disproving Viterbo’s conjecture in all dimensions via product lifts.
tags: [viterbo, counterexample, lagrangian-product]
---
...
- Proposition `counterexample_prop`: for $K$ a unit regular pentagon and $T=R_{90^\circ}K$,
  $ c_{EHZ}(K\times T)=2\cos(\tfrac{\pi}{10})(1+\cos(\tfrac{\pi}{5})) $, achieved by a 2-bounce $T$-billiard along a diagonal.
