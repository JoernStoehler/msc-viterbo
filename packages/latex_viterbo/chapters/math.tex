...
\begin{description}
  ...
  \item[Almost complex structure] \(\Jmat = \begin{pmatrix}0 & -I_2 \\ I_2 & 0\end{pmatrix}\) so that \(\Jmat^2 = -I_4\).
  \item[Symplectic form] \(\omegaform = \sum_{i=1}^2 dq_i \wedge dp_i\), equivalently \(\omegaform(x,y)=\inner{\Jmat x}{y}\).
