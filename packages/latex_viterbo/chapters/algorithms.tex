...
\begin{theorem}[Iterative Tube Data Computation]
  ...
  \begin{description}
    ...
    \item[Rotation] Let \(\rho \in \R_{\ge 0}\) be the combinatorial rotation number of the trajectories in the sense of Chaidez--Hutchings \cite{CH2021}, measured in turns (i.e. \(1 = 2\pi\)).
