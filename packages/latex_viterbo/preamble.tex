...
% WIP references: \todoref{label} shows a visible TODO while the label
% does not exist yet; once the label exists (i.e. on a later run where
% \r@<label> is defined), this raises a LaTeX error to force cleanup.
\makeatletter
\newcommand{\todoref}[1]{%
