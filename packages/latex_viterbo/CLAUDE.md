...
assets/
  <label>/          # Figures from experiments (generated by python_viterbo)
...
The thesis is the source of truth for mathematical definitions. Code implements what the thesis specifies. See `docs/conventions/math-code-correspondence.md`.
