...
<!-- Intended readers: mathematicians, reviewers, and scientists. Agents use AGENTS.md and .codex/skills. -->
...
The project is designed to be reproducible in the provided devcontainer with scripted pipelines. For the exact steps, see `AGENTS.md`.
