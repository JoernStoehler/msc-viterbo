...
Purpose: hold project-wide knowledge that applies across packages and toolchains. Package-specific material lives in `packages/*/docs/`; thesis prose lives in `packages/thesis/src/`.
...
- Do not store thesis chapters or drafts here; those belong under `packages/thesis/src/` (public) or `packages/thesis/src/internal/` (draft/internal).
