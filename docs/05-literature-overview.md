...
Purpose: quick lookup of which papers provide which facts for the thesis (math intro + algorithms). Keep this synced with the archived reading plan at `docs/archive/msc-proto/briefs/2025-10-12-workflow-reading-list.md`.
